        ...
        <div class="col-md-10">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-header bg-dark text-white border-0">
                    <h4 class="mb-0"><i class="fas fa-plus-circle me-2"></i> Crear Nuevo Casa</h4>
                </div>
                    ...
                    <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 border-end pe-4">
                                ...
                                <h6 class="text-muted">Detalles de la Casa</h6>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control @error('cantidad_minima') is-invalid @enderror" id="cantidad_minima" name="cantidad_minima" value="{{ old('cantidad_minima', 1) }}" min="0" required>
                                        </div>
